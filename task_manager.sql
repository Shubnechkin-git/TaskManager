...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 20 2024 г., 02:46
...
INSERT INTO `users` (`id`, `vk_id`) VALUES
(16, 334474821),
(17, 210877741);
...
INSERT INTO `user_tasks` (`id`, `vk_id`, `title`, `textarea`, `list`, `image`, `timer`) VALUES
(3, '334474821', '', NULL, NULL, NULL, NULL);
