...
export default function Counter(props) {
    ...
    const handleAdd = () => {
        axios.put('https://taskmanagerbackend.cleverapps.io/counters/update_count', { id: props.id, vk_id: props.vk_id, count: counter + 1 }).then((response) => {
    ...
    return (
        <div>
            ...
            <div className='d-flex chet__body' id={props.id}>
                <div className='add d-flex justify-content-center align-items-center' onClick={e => handleAdd()}><Icon20AddCircleFillGreen /></div>
                <div className='d-flex flex-column text-center w-100'>
                    <span>{props.title}</span>
                    <span>{counter}</span>
                </div>
                <div onClick={e => handleMinus()} className='minus d-flex justify-content-center align-items-center'><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
