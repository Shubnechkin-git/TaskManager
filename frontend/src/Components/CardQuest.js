...
export default function CardQuest(props) {
  ...
  function handleChange(e) {
    ...
    reader.onload = () => {
      ...
      axios
        .post("https://taskmanagerbackend.cleverapps.io/tasks/upload_image", {
          data: { file: reader.result, id: props.vk_id, id_task: props.id },
        })
        .then((response) => {
  ...
  const handleDelete = () => {
    axios
      .delete("https://taskmanagerbackend.cleverapps.io/tasks/delete_task", {
  ...
  const handleDone = () => {
    axios
      .delete("https://taskmanagerbackend.cleverapps.io/tasks/done_task", {
        params: { id: props.id, vk_id: props.vk_id },
      })
      .then((response) => {
        if (response.data.success) {
