import { Icon16Cancel, Icon24Camera } from "@vkontakte/icons";
      ...
      .then((res) => {
        if (vk_id > 0 && title != null) {
          ...
          if (title != null)
            axios
              .post(
                "https://taskmanagerbackend.cleverapps.io/tasks/create_task",
                taskData
              )
              .then((response) => {
      ...
      <div className="container_quest">
        ...
        <div className="container_input d-flex flex-column">
          ...
          <textarea
            ...
            placeholder="Сделать домашнее задание по русскому"
          ></textarea>
          {counter[1]}/1000
        </div>
        <div className="container_input d-flex flex-column">
