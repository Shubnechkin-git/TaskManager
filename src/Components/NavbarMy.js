                ...
                <Panel id={props.id}>
                    <Row className='nav'>
                        <Col className="d-flex justify-content-start nav__btn1 align-items-center">
                            <div className='btn__border d-flex justify-content-center align-items-center ' onClick={props.go} data-to="calendar">
                        ...
                        <Col className="d-flex justify-content-end nav__btn3 align-items-center" >
                            <div className='btn__border d-flex justify-content-center align-items-center' onClick={props.go} data-to="settings" >
