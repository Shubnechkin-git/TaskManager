            ...
            <Styled>
                <div className='card_quest'>
                    <div className='header_quest d-flex justify-content-between align-items-center'>
                        <div>
                            <span className='fw-bold'>Задача 1.</span>
                        </div>
                        ...
                        <div className='quest_foot'>
                            <div className='quest_description'>
                                <textarea>
                                    ...
                                    Nunc nunc magna aliquet nulla dis turpis massa.
                                    Felis consectetur pulvinar vestibulum adipiscing volutpat dolor vel.
                                    Mollis bibendum tortor velit feugiat vulputate massa. Cras amet lorem gravida in.
                                    Posuere nibh scelerisque in tristique volutpat. Orci aliquam molestie amet a.
                                    Suspendisse tincidunt natoque tristique a.
                                    Duis in egestas habitant feugiat imperdiet proin.
                                    Pharetra justo mollis lacus ac cras.
                                </textarea>
                            </div>
                        </div>
                    </div>
